...
from ckanext.schemingdcat.harvesters.base import SchemingDCATHarvester, RemoteSchemaError
...
class SchemingDCATCKANHarvester(SchemingDCATHarvester):
    ...
    def info(self):
        return {
            ...
            'about_url': 'https://github.com/mjanez/ckanext-schemingdcat?tab=readme-ov-file#scheming-dcat-ckan-harvester'
        }
