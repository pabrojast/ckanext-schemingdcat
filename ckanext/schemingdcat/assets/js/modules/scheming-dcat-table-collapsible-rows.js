 ...
 *
 * @module scheming-dcat-table-collapsible-rows
 * @requires jQuery
 * @requires Mustache
 ...
 * @example
 * // Import the module
 * var tableCollapsibleRows = this.ckan.module('scheming-dcat-table-collapsible-rows');
 *
...
(function () {
    ...
    this.ckan.module('scheming-dcat-table-collapsible-rows', function ($, _) {
