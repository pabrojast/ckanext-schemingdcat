...
# No configuro estas variables al principio del todo porque no sé si luego la aplicación cargará otras extensiones
# con información que pueda necesitar. Configurándolas con la primera petición me aseguro que todo está en orden y
